# Generated by Django 2.2.17 on 2021-06-17 17:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hp', models.IntegerField(null=True, unique=True, verbose_name='phone')),
                ('username', models.CharField(max_length=8, null=True, verbose_name='username')),
                ('level', models.CharField(choices=[('3', 'Lv3_External'), ('2', 'Lv2_Internal'), ('1', 'Lv1_Manager'), ('0', 'Lv0_Developer')], default=3, max_length=18, verbose_name='level')),
