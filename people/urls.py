...
urlpatterns = [
    ...
    path('members/postDoctor/<int:pk>/', views.postDoctor_registration, name='postDoctor_modify'),
    path('members/phd/<int:pk>/', views.phd_registration, name='phd_modify'),
    path('members/master/<int:pk>/', views.phd_registration, name='master_modify'),
